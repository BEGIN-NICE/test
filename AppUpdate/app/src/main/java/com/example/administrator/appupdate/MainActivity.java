                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (getDirMD5(downLoadFile, mInformationData.getMd5())) {
                        ...
                        installDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                File downLoadFile1 = new File(getSystemFilePath(MainActivity.this)+"/"+mInformationData.getFilename());
                                Intent install = new Intent(Intent.ACTION_VIEW);

                               Uri contentUri = FileProvider.getUriForFile(MainActivity.this,"com.example.administrator.appupdate.provider",downLoadFile);
 //                               Uri photoURI = FileProvider.getUriForFile(MainActivity.this, MainActivity.this.getApplicationContext().getPackageName() + ".provider", downLoadFile);
 //                               Uri downLoadFileUri = getImageContentUri(MainActivity.this,downLoadFile1);
